...
//import java.util.*;
//
//public class LlistarLikes implements iLlistar {
//    @Override
//    public List<Punt_dePas> llistarAll(Map<String, Ruta> rutaMap, String rutaNom) {
//        return obtenirLlistaPuntsPas(rutaMap, rutaNom);
//    }
//
//    @Override
...
//        Comparator<Punt_dePas> comparar = Comparator.comparing(Punt_dePas::getLikes);
